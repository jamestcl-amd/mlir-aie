...
// RUN: mlir-opt linalg.mlir --linalg-fuse-elementwise-ops --func-bufferize --linalg-bufferize --arith-bufferize --canonicalize --cse --buffer-results-to-out-params --buffer-deallocation --convert-linalg-to-affine-loops --affine-super-vectorize="virtual-vector-size=16" -o affine.mlir 
...
module {
  func.func @dut(%arg0: tensor<1024xbf16>, %arg1: tensor<1024xbf16>) -> (tensor<1024xbf16>) {
    %1 = "tosa.add"(%arg0,%arg1) : (tensor<1024xbf16>, tensor<1024xbf16>)  -> (tensor<1024xbf16>)
